    ...
    <div data-role="content" align="center" data-theme="b" class="bg">
            <div data-role="fieldcontain" class="userifo_area ui-corner-all" align="center">
             ...
             <div id="auth_btns" align="center" >
	            <a href="supplies.php" data-role="button" data-iconpos="right" onclick="changePage('#',false);" >Supplies/Prepare<img style="float: right; margin-right: -25px" src="images/next.png"></a>
	            <a href="#" data-role="button" data-iconpos="right" onclick="changePage('map.php',false);">Locations Map<img style="float: right; margin-right: -25px" src="images/next.png"></a>
                <a href="#" data-role="button" data-iconpos="right" onclick="changePage('location_list.php',false);" >Locations List<img style="float: right; margin-right: -25px" src="images/next.png"></a>
	            <a href="#" data-role="button" data-iconpos="right" onclick="changePage('forms.php',false);" >Collect Data<img style="float: right; margin-right: -25px" src="images/next.png"></a>
	            <a href="#" data-role="button" data-iconpos="right" onclick="changePage('#',false);">Task Description/Docs<img style="float: right; margin-right: -25px" src="images/next.png"></a>
            </div>
	</div><!-- /content -->
